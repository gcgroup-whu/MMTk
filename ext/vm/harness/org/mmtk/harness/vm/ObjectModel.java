...
public final class ObjectModel extends org.mmtk.vm.ObjectModel {
  ...
  public static final int HEADER_WORDS = (IS_32_BIT ? 6 : 4) + ActivePlan.constraints.gcHeaderWords();
  ...
  /** The offset of the first age field. */
  public static final Offset AGE_OFFSET = DATACOUNT_OFFSET.plus(MemoryConstants.BYTES_IN_INT);
  /** The offset of the UInt32 storing the number of reference fields */
  private static final Offset REFCOUNT_OFFSET  = AGE_OFFSET.plus(MemoryConstants.BYTES_IN_INT);
  ...
  private static void printObjectLayout(PrintStream wr) {
    ...
    wr.printf("DATACOUNT_OFFSET=%s, AGE_OFFSET=%s,REFCOUNT_OFFSET=%s, STATUS_OFFSET=%s%n",
        DATACOUNT_OFFSET, AGE_OFFSET, REFCOUNT_OFFSET, STATUS_OFFSET);
...
//    }
   ...
   * @return The age
   */
  public static int getAge(ObjectReference object) {
    return object.toAddress().loadInt(AGE_OFFSET);
  }

  /**
   * Set the age of the object.
   */
  public static void setAge(ObjectReference object, int age) {
    object.toAddress().store(age, AGE_OFFSET);
  }
   ...
   * @return The GcHeader
   */
  public static int getGcHeader(ObjectReference object) {
    return object.toAddress().loadInt(GC_OFFSET);
  }

  /**
   * Set the GcHeader of the object.
   */
  public static void setGcHeader(ObjectReference object, int gcHeader) {
    object.toAddress().store(gcHeader, GC_OFFSET);
  }
  ...
  public static void dumpObjectHeader1(ObjectReference object) {
    int gcWord = object.toAddress().loadInt(GC_OFFSET);
    int statusWord = object.toAddress().loadInt(STATUS_OFFSET);
    System.err.println("object " + gcWord);
  }
